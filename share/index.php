			...
			<div class="sectionWrapper">
				...
				<div class="sectionContent bigContent">
					...
					<p class="highlight upperCase">
						Support Shadow with three clicks
					</p>
					...
					<div id="shareAction" class="cf links">
						
						<div id="facebookShare" class="actionBox">
							...
							<p class="highlight">
								Please share SHADOW <br> with your friends
							</p>
							
							<a href="#" id="facebookIcon"><span>Facebook</span></a>
							
						</div>
						
						<div id="twitterShare" class="actionBox">
							...
							<p class="highlight">
								Please also hook your <br> following up
							</p>
							
							<a href="#" id="twitterIcon"><span>Tumblr</span></a>
							
						</div>
						
						<div id="videoWatch" class="actionBox">
							...
							<p class="highlight">
								Thank you in advance for <br> backing SHADOW
							</p>
							
							<a href="#" id="videoIcon"><span>Video</span></a>
...
<script>
    (function(d, s, id) {
      ...
      js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=270058479685802";
